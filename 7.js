...
const msgs = [
  {role: "system", content: `The user will give you a city name. Describe the city including the major industry and a fun thing to do there. Output as JSON using this schema: 
